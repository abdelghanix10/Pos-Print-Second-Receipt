...
- Prints a simplified second receipt with order details
- Configurable: can be enabled or disabled per POS configuration

## Configuration

To enable or disable the second receipt printing:

1. Go to **Point of Sale > Configuration > Point of Sale**
2. Select the POS configuration you want to modify
